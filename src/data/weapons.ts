...
킬체인(Kill Chain)의 핵심 유인 타격 수단. 스텔스 특성을 활용한 종심 침투 정밀 타격 및 제공권 확보.`,
...

  {
    ...
    status: 'TESTING',
    threatRating: 'LOW',
    description: '한국형 4.5세대 전투기. 2026년 초도작전능력(IOC) 달성 목표.',
    detail: `## KF-21 보라매
...
### 개발 현황 (2026년 6월)
- 2022년 7월 초도비행 성공
- 시제 6호기 완성, 비행 시험 진행 중
- 2026년 IOC(초도작전능력) 획득 목표
- 2032년까지 120기 국내 도입 계획

### 주요 특징
- 내부 무장창 없음 (외부 파일런)
- AN/APG-83 SABR AESA 레이더 탑재 (초기형)
- Block 3에서 스텔스 특성 강화 예정
- 한화에어로스페이스 엔진 (GE-414)

### 수출 전망
KF-21은 F-35보다 저렴한 가격대(대당 약 800억원 수준)로 동남아, 중동 수출 타깃.`,
    specs: {
      range: '전투행동반경 900km',
      speed: '마하 1.81',
      ceiling: '16,000m',
      crew: '1명 (복좌형 2명)',
      length: '16.9m',
      armament: '20mm 기관포, AIM-120, 미티어, 천검, JDAM',
      manufacturer: 'KAI (한국항공우주산업)',
      firstDeployed: '2026년 IOC 예정',
      quantity: '120기 계획',
    },
    confidence: 96,
    lastUpdated: '2026-06-15',
    relatedIntelIds: [],
    tags: ['4.5세대', '전투기', '국산', 'KAI', 'KFX'],
    sources: ['KAI', '방위사업청', '공군'],
  },
