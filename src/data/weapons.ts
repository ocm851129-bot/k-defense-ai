...
import { WEAPONS_BATCH78_SPECIAL_FORCES_POLICE } from './weaponsBatch78_SpecialForcesPolice'
import { WEAPONS_BATCH79_NAVAL_AUXILIARY } from './weaponsBatch79_NavalAuxiliary'
import { WEAPONS_BATCH80_AIR_DEFENSE_VARIANTS } from './weaponsBatch80_AirDefenseVariants'
import { WEAPONS_BATCH81_SPACE_SATELLITE_PROGRAMS } from './weaponsBatch81_SpaceSatellitePrograms'
import { WEAPONS_BATCH82_ENGINEER_LOGISTICS_VEHICLES } from './weaponsBatch82_EngineerLogisticsVehicles'
import { WEAPONS_BATCH83_SCOUT_VEHICLES_COMMS } from './weaponsBatch83_ScoutVehiclesComms'
import { WEAPONS_BATCH84_TRAINERS_MUNITIONS } from './weaponsBatch84_TrainersMunitions'
import { WEAPONS_BATCH85_FINAL_PUSH1 } from './weaponsBatch85_FinalPush1'
...
수도권 방어 및 전방 타격 임무에 육군 미사일 여단이 운용 중. 개량형 현무-2B/C로 단계적 교체 진행 중.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/ROK-US_Alliance_Demonstrates_Precision_Firing_Capability.ogv/1920px--ROK-US_Alliance_Demonstrates_Precision_Firing_Capability.ogv.jpg',
    wikiUrl: 'https://ko.wikipedia.org/wiki/현무-2',
  },
...
- 폴란드: 구매 관심 표명`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/6a/A_scale_model_of_the_KM-SAM_Block_2_missile.jpg',
    wikiUrl: 'https://ko.wikipedia.org/wiki/천궁_(미사일)',
  },
...
대당 약 800억원 수준으로 F-35 대비 경쟁력 있는 가격. 말레이시아·UAE·폴란드 수출 협상 진행 중.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/KF-21_Boramae_First_Production.jpg/1280px-KF-21_Boramae_First_Production.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/KAI_KF-21_Boramae',
  },
...
장거리 정밀타격 임무 — 북한 지도부, 핵·미사일 시설 타격. JASSM-ER로 비행금지구역 진입 없이 종심 타격 가능.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/42/F-15K_lands_at_Nellis_AFB.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/F-15K_Slam_Eagle',
  },
...
- 노르웨이, 루마니아 등 추가 수출 논의 중`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/U.S.%2C_ROK_forces_forge_interoperability_with_combined_arms_exercise_-_8_of_8.jpg/1280px-U.S.%2C_ROK_forces_forge_interoperability_with_combined_arms_exercise_-_8_of_8.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/K2_Black_Panther',
  },
...
인도, 폴란드, 핀란드, 노르웨이, 에스토니아, 호주, 이집트, 터키, 루마니아 등 18개국+`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ed/2011.2.17_%EC%9C%A1%EA%B5%B06%ED%8F%AC%EB%B3%91%EC%97%AC%EB%8B%A8_k-9%2Ck-55_%EC%9E%90%EC%A3%BC%ED%8F%AC%EC%82%AC%EA%B2%A9_%287633864346%29.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/K9_Thunder',
  },
...
폴란드, UAE, 사우디아라비아 등에 수출. 폴란드는 K9과 함께 천무 288문 계약.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/K239_Chunmoo_Image7.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/K239_Chunmoo',
  },
...
- KDX-III Batch II: 정조대왕함 (2023년 취역), 추가 2척 건조 중`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/ROKS_Sejong_the_Great_%28DDG-991%29%2C_broadside_view_in_July_2010.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/Sejong_the_Great-class_destroyer',
  },
...
- Batch II: 사거리/탑재량 향상형 3척 추가 계획`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/65/ROKS_Dosan_Ahn_Changho_class_submarine.png',
    wikiUrl: 'https://en.wikipedia.org/wiki/Dosan_Ahn_Changho-class_submarine',
  },
...
2023년부터 육군 배치 시작. 해외파병부대 및 후방 지역 임무 전력으로 활용.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/fc/ROKA_K808_APC_river_crossing_training_-_March_2021.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/K808_White_Tiger',
  },
...
MIRV 탑재 시 미사일 방어망(MD) 돌파력 대폭 상승. 미 MD 체계를 포화시킬 수 있는 최초의 북한 ICBM으로 평가.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Diagram_of_Hwasong-17.svg',
    wikiUrl: 'https://en.wikipedia.org/wiki/Hwasong-17',
  },
...
주한미군 증원 경로인 괌 기지를 직접 타격할 수 있어 미군 전략예비대에 직접 위협. 2022년 이후 연속 시험발사 재개.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/56/Diagram_of_Hwasong-12_and_Modified_Hwasong-12.svg',
    wikiUrl: 'https://en.wikipedia.org/wiki/Hwasong-12',
  },
...
북한이 러시아에 KN-23을 대량 수출한 것으로 알려짐. 러-우크라이나 전쟁에서 실전 사용 중.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/b9/Diagram_of_KN-23.svg',
    wikiUrl: 'https://en.wikipedia.org/wiki/Hwasong-11A',
  },
...
중국은 AN/TPY-2 레이더의 중국 탐지 능력을 문제 삼아 강력 항의. 사드 배치로 한·중 관계 장기 갈등.`,
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/45/The_first_of_two_Terminal_High_Altitude_Area_Defense_%28THAAD%29_interceptors_is_launched_during_a_successful_intercept_test_-_US_Army.jpg',
    wikiUrl: 'https://en.wikipedia.org/wiki/Terminal_High_Altitude_Area_Defense',
  },
...
- AGM-86B 핵 순항미사일 20발 탑재 가능`,
    ...
    sources: ['USAF', '국방부'],
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/16/B-52_Stratofortress_assigned_to_the_307th_Bomb_Wing_%28cropped%29.jpg',
...
중국의 DF-41 전력 확충은 미국의 확장억제 신뢰성에 영향. 중국이 북한 문제에서 한·미의 압박 수단을 제한하는 배경 전력.`,
  ...
  ...WEAPONS_BATCH78_SPECIAL_FORCES_POLICE,
  ...WEAPONS_BATCH79_NAVAL_AUXILIARY,
  ...WEAPONS_BATCH80_AIR_DEFENSE_VARIANTS,
  ...WEAPONS_BATCH81_SPACE_SATELLITE_PROGRAMS,
  ...WEAPONS_BATCH82_ENGINEER_LOGISTICS_VEHICLES,
  ...WEAPONS_BATCH83_SCOUT_VEHICLES_COMMS,
  ...WEAPONS_BATCH84_TRAINERS_MUNITIONS,
  ...WEAPONS_BATCH85_FINAL_PUSH1,
]
